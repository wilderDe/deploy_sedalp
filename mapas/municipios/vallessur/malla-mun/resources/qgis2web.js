...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [602511.606800, 8048328.383300, 741976.543800, 8202741.285500], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([602511.606800, 8048328.383300, 741976.543800, 8202741.285500], map.getSize());
