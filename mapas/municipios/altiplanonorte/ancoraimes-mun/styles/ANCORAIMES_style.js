...
var styleCache_ANCORAIMES={}
var style_ANCORAIMES = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ANCORAIMES[key]){
        ...
        styleCache_ANCORAIMES[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ANCORAIMES[key]];
