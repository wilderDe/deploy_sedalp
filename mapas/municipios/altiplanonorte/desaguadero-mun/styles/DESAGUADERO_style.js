...
var styleCache_DESAGUADERO={}
var style_DESAGUADERO = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_DESAGUADERO[key]){
        ...
        styleCache_DESAGUADERO[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_DESAGUADERO[key]];
