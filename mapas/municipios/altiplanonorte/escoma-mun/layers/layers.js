...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_ESCOMA = new ol.format.GeoJSON();
var features_ESCOMA = format_ESCOMA.readFeatures(geojson_ESCOMA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_ESCOMA = new ol.source.Vector();
jsonSource_ESCOMA.addFeatures(features_ESCOMA);var lyr_ESCOMA = new ol.layer.Vector({
                source:jsonSource_ESCOMA, 
                style: style_ESCOMA,
                title: "ESCOMA"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_ESCOMA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_ESCOMA];
