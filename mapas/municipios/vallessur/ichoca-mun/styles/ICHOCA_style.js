...
var styleCache_ICHOCA={}
var style_ICHOCA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ICHOCA[key]){
        ...
        styleCache_ICHOCA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ICHOCA[key]];
