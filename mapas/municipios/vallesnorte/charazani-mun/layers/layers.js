...
jsonSource_MUNICIPIOSVALLENORTE.addFeatures(features_MUNICIPIOSVALLENORTE);var lyr_MUNICIPIOSVALLENORTE = new ol.layer.Vector({
            ...
            });var format_CHARAZANI = new ol.format.GeoJSON();
var features_CHARAZANI = format_CHARAZANI.readFeatures(geojson_CHARAZANI, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_CHARAZANI = new ol.source.Vector();
jsonSource_CHARAZANI.addFeatures(features_CHARAZANI);var lyr_CHARAZANI = new ol.layer.Vector({
                source:jsonSource_CHARAZANI, 
                style: style_CHARAZANI,
                title: "CHARAZANI"
            });

lyr_REGIONVALLESDELNORTE.setVisible(true);lyr_MUNICIPIOSVALLENORTE.setVisible(true);lyr_CHARAZANI.setVisible(true);
var layersList = [baseLayer,lyr_REGIONVALLESDELNORTE,lyr_MUNICIPIOSVALLENORTE,lyr_CHARAZANI];
