...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_COLQUENCHA = new ol.format.GeoJSON();
var features_COLQUENCHA = format_COLQUENCHA.readFeatures(geojson_COLQUENCHA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_COLQUENCHA = new ol.source.Vector();
jsonSource_COLQUENCHA.addFeatures(features_COLQUENCHA);var lyr_COLQUENCHA = new ol.layer.Vector({
                source:jsonSource_COLQUENCHA, 
                style: style_COLQUENCHA,
                title: "COLQUENCHA"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_COLQUENCHA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_COLQUENCHA];
