...
var styleCache_PALCA={}
var style_PALCA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_PALCA[key]){
        ...
        styleCache_PALCA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PALCA[key]];
