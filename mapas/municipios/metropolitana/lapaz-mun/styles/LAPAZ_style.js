...
var styleCache_LAPAZ={}
var style_LAPAZ = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_LAPAZ[key]){
        ...
        styleCache_LAPAZ[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_LAPAZ[key]];
