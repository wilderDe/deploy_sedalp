...
jsonSource_MUNICIPIOSVALLENORTE.addFeatures(features_MUNICIPIOSVALLENORTE);var lyr_MUNICIPIOSVALLENORTE = new ol.layer.Vector({
            ...
            });var format_PELECHUCO = new ol.format.GeoJSON();
var features_PELECHUCO = format_PELECHUCO.readFeatures(geojson_PELECHUCO, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_PELECHUCO = new ol.source.Vector();
jsonSource_PELECHUCO.addFeatures(features_PELECHUCO);var lyr_PELECHUCO = new ol.layer.Vector({
                source:jsonSource_PELECHUCO, 
                style: style_PELECHUCO,
                title: "PELECHUCO"
            });

lyr_REGIONVALLESDELNORTE.setVisible(true);lyr_MUNICIPIOSVALLENORTE.setVisible(true);lyr_PELECHUCO.setVisible(true);
var layersList = [baseLayer,lyr_REGIONVALLESDELNORTE,lyr_MUNICIPIOSVALLENORTE,lyr_PELECHUCO];
