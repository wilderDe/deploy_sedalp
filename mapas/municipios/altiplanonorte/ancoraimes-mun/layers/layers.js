...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_ANCORAIMES = new ol.format.GeoJSON();
var features_ANCORAIMES = format_ANCORAIMES.readFeatures(geojson_ANCORAIMES, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_ANCORAIMES = new ol.source.Vector();
jsonSource_ANCORAIMES.addFeatures(features_ANCORAIMES);var lyr_ANCORAIMES = new ol.layer.Vector({
                source:jsonSource_ANCORAIMES, 
                style: style_ANCORAIMES,
                title: "ANCORAIMES"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_ANCORAIMES.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_ANCORAIMES];
