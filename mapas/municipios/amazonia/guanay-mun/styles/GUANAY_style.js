...
var styleCache_GUANAY={}
var style_GUANAY = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_GUANAY[key]){
        ...
        styleCache_GUANAY[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_GUANAY[key]];
