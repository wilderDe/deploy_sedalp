...
var styleCache_PUERTOPEREZ={}
var style_PUERTOPEREZ = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_PUERTOPEREZ[key]){
        ...
        styleCache_PUERTOPEREZ[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PUERTOPEREZ[key]];
