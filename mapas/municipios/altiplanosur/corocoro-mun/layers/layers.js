...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_COROCORO = new ol.format.GeoJSON();
var features_COROCORO = format_COROCORO.readFeatures(geojson_COROCORO, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_COROCORO = new ol.source.Vector();
jsonSource_COROCORO.addFeatures(features_COROCORO);var lyr_COROCORO = new ol.layer.Vector({
                source:jsonSource_COROCORO, 
                style: style_COROCORO,
                title: "COROCORO"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_COROCORO.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_COROCORO];
