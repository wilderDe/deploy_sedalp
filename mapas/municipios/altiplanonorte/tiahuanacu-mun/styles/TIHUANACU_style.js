...
var styleCache_TIHUANACU={}
var style_TIHUANACU = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_TIHUANACU[key]){
        ...
        styleCache_TIHUANACU[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_TIHUANACU[key]];
