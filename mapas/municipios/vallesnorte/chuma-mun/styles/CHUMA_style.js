...
var styleCache_CHUMA={}
var style_CHUMA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_CHUMA[key]){
        ...
        styleCache_CHUMA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_CHUMA[key]];
