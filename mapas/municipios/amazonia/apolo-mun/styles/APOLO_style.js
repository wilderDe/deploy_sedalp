...
var styleCache_APOLO={}
var style_APOLO = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_APOLO[key]){
        ...
        styleCache_APOLO[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_APOLO[key]];
