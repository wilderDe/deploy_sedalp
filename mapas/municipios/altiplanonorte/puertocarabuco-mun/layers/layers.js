...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_PUERTOCARABUCO = new ol.format.GeoJSON();
var features_PUERTOCARABUCO = format_PUERTOCARABUCO.readFeatures(geojson_PUERTOCARABUCO, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_PUERTOCARABUCO = new ol.source.Vector();
jsonSource_PUERTOCARABUCO.addFeatures(features_PUERTOCARABUCO);var lyr_PUERTOCARABUCO = new ol.layer.Vector({
                source:jsonSource_PUERTOCARABUCO, 
                style: style_PUERTOCARABUCO,
                title: "PUERTO_CARABUCO"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_PUERTOCARABUCO.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_PUERTOCARABUCO];
