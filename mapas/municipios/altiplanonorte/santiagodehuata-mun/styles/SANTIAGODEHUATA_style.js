...
var styleCache_SANTIAGODEHUATA={}
var style_SANTIAGODEHUATA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_SANTIAGODEHUATA[key]){
        ...
        styleCache_SANTIAGODEHUATA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_SANTIAGODEHUATA[key]];
