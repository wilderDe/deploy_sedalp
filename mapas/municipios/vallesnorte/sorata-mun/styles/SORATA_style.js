...
var styleCache_SORATA={}
var style_SORATA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_SORATA[key]){
        ...
        styleCache_SORATA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_SORATA[key]];
