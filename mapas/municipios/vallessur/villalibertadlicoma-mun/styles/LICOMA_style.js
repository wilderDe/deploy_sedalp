...
var styleCache_LICOMA={}
var style_LICOMA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_LICOMA[key]){
        ...
        styleCache_LICOMA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_LICOMA[key]];
