...
var styleCache_ELALTO={}
var style_ELALTO = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ELALTO[key]){
        ...
        styleCache_ELALTO[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ELALTO[key]];
