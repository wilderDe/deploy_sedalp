...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [541417.118800, 8129495.111200, 647330.582500, 8257310.058100], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([541417.118800, 8129495.111200, 647330.582500, 8257310.058100], map.getSize());
