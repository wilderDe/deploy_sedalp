...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_SANPEDROCURAHUARA = new ol.format.GeoJSON();
var features_SANPEDROCURAHUARA = format_SANPEDROCURAHUARA.readFeatures(geojson_SANPEDROCURAHUARA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_SANPEDROCURAHUARA = new ol.source.Vector();
jsonSource_SANPEDROCURAHUARA.addFeatures(features_SANPEDROCURAHUARA);var lyr_SANPEDROCURAHUARA = new ol.layer.Vector({
                source:jsonSource_SANPEDROCURAHUARA, 
                style: style_SANPEDROCURAHUARA,
                title: "SANPEDROCURAHUARA"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_SANPEDROCURAHUARA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_SANPEDROCURAHUARA];
