...
var styleCache_CURVA={}
var style_CURVA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_CURVA[key]){
        ...
        styleCache_CURVA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_CURVA[key]];
