...
jsonSource_MUNICIPIOSAMAZONIA.addFeatures(features_MUNICIPIOSAMAZONIA);var lyr_MUNICIPIOSAMAZONIA = new ol.layer.Vector({
            ...
            });var format_MAPIRI = new ol.format.GeoJSON();
var features_MAPIRI = format_MAPIRI.readFeatures(geojson_MAPIRI, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_MAPIRI = new ol.source.Vector();
jsonSource_MAPIRI.addFeatures(features_MAPIRI);var lyr_MAPIRI = new ol.layer.Vector({
                source:jsonSource_MAPIRI, 
                style: style_MAPIRI,
                title: "MAPIRI"
            });

lyr_REGIONDELAAMAZONIA.setVisible(true);lyr_MUNICIPIOSAMAZONIA.setVisible(true);lyr_MAPIRI.setVisible(true);
var layersList = [baseLayer,lyr_REGIONDELAAMAZONIA,lyr_MUNICIPIOSAMAZONIA,lyr_MAPIRI];
