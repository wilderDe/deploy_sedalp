...
var styleCache_CHARAA={}
var style_CHARAA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_CHARAA[key]){
        ...
        styleCache_CHARAA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_CHARAA[key]];
