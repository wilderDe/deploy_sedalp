...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_TIHUANACU = new ol.format.GeoJSON();
var features_TIHUANACU = format_TIHUANACU.readFeatures(geojson_TIHUANACU, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_TIHUANACU = new ol.source.Vector();
jsonSource_TIHUANACU.addFeatures(features_TIHUANACU);var lyr_TIHUANACU = new ol.layer.Vector({
                source:jsonSource_TIHUANACU, 
                style: style_TIHUANACU,
                title: "TIHUANACU"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_TIHUANACU.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_TIHUANACU];
