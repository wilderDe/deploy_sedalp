...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_GUAQUI = new ol.format.GeoJSON();
var features_GUAQUI = format_GUAQUI.readFeatures(geojson_GUAQUI, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_GUAQUI = new ol.source.Vector();
jsonSource_GUAQUI.addFeatures(features_GUAQUI);var lyr_GUAQUI = new ol.layer.Vector({
                source:jsonSource_GUAQUI, 
                style: style_GUAQUI,
                title: "GUAQUI"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_GUAQUI.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_GUAQUI];
