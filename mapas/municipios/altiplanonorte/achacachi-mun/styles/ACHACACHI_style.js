...
var styleCache_ACHACACHI={}
var style_ACHACACHI = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ACHACACHI[key]){
        ...
        styleCache_ACHACACHI[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ACHACACHI[key]];
