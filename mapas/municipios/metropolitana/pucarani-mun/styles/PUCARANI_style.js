...
var styleCache_PUCARANI={}
var style_PUCARANI = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_PUCARANI[key]){
        ...
        styleCache_PUCARANI[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PUCARANI[key]];
