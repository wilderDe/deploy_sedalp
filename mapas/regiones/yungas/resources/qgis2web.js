...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [610413.071400, 8148415.839000, 735513.219800, 8349676.214100], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([610413.071400, 8148415.839000, 735513.219800, 8349676.214100], map.getSize());
