...
var styleCache_MAPIRI={}
var style_MAPIRI = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_MAPIRI[key]){
        ...
        styleCache_MAPIRI[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_MAPIRI[key]];
