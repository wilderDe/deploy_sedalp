...
var styleCache_MALLA={}
var style_MALLA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_MALLA[key]){
        ...
        styleCache_MALLA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_MALLA[key]];
