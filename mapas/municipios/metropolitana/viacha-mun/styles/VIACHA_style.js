...
var styleCache_VIACHA={}
var style_VIACHA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_VIACHA[key]){
        ...
        styleCache_VIACHA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_VIACHA[key]];
