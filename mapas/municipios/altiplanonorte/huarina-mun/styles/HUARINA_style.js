...
var styleCache_HUARINA={}
var style_HUARINA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_HUARINA[key]){
        ...
        styleCache_HUARINA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_HUARINA[key]];
