...
var styleCache_PUERTOACOSTA={}
var style_PUERTOACOSTA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_PUERTOACOSTA[key]){
        ...
        styleCache_PUERTOACOSTA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PUERTOACOSTA[key]];
