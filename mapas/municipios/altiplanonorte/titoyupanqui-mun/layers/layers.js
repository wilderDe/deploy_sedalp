...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_TITOYUPANQUI = new ol.format.GeoJSON();
var features_TITOYUPANQUI = format_TITOYUPANQUI.readFeatures(geojson_TITOYUPANQUI, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_TITOYUPANQUI = new ol.source.Vector();
jsonSource_TITOYUPANQUI.addFeatures(features_TITOYUPANQUI);var lyr_TITOYUPANQUI = new ol.layer.Vector({
                source:jsonSource_TITOYUPANQUI, 
                style: style_TITOYUPANQUI,
                title: "TITO_YUPANQUI"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_TITOYUPANQUI.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_TITOYUPANQUI];
