...
var styleCache_TITOYUPANQUI={}
var style_TITOYUPANQUI = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_TITOYUPANQUI[key]){
        ...
        styleCache_TITOYUPANQUI[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_TITOYUPANQUI[key]];
