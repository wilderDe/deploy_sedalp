...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_WALDOBALLIVIAN = new ol.format.GeoJSON();
var features_WALDOBALLIVIAN = format_WALDOBALLIVIAN.readFeatures(geojson_WALDOBALLIVIAN, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_WALDOBALLIVIAN = new ol.source.Vector();
jsonSource_WALDOBALLIVIAN.addFeatures(features_WALDOBALLIVIAN);var lyr_WALDOBALLIVIAN = new ol.layer.Vector({
                source:jsonSource_WALDOBALLIVIAN, 
                style: style_WALDOBALLIVIAN,
                title: "WALDO_BALLIVIAN"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_WALDOBALLIVIAN.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_WALDOBALLIVIAN];
