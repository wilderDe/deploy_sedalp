...
var styleCache_HUMANATA={}
var style_HUMANATA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_HUMANATA[key]){
        ...
        styleCache_HUMANATA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_HUMANATA[key]];
