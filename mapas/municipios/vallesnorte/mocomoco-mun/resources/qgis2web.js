...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [460962.177500, 8236864.430600, 591251.115000, 8396749.114800], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([460962.177500, 8236864.430600, 591251.115000, 8396749.114800], map.getSize());
