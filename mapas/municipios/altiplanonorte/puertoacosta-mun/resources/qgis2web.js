...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [463420.517200, 8155032.576500, 590432.062200, 8311039.203500], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([463420.517200, 8155032.576500, 590432.062200, 8311039.203500], map.getSize());
