...
var styleCache_BATALLAS={}
var style_BATALLAS = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_BATALLAS[key]){
        ...
        styleCache_BATALLAS[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_BATALLAS[key]];
