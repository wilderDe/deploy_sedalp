...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [431469.139300, 8003908.875400, 672857.218100, 8159892.516900], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([431469.139300, 8003908.875400, 672857.218100, 8159892.516900], map.getSize());
