...
jsonSource_MUNICIPIOSVALLENORTE.addFeatures(features_MUNICIPIOSVALLENORTE);var lyr_MUNICIPIOSVALLENORTE = new ol.layer.Vector({
            ...
            });var format_AYATA = new ol.format.GeoJSON();
var features_AYATA = format_AYATA.readFeatures(geojson_AYATA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_AYATA = new ol.source.Vector();
jsonSource_AYATA.addFeatures(features_AYATA);var lyr_AYATA = new ol.layer.Vector({
                source:jsonSource_AYATA, 
                style: style_AYATA,
                title: "AYATA"
            });

lyr_REGIONVALLESDELNORTE.setVisible(true);lyr_MUNICIPIOSVALLENORTE.setVisible(true);lyr_AYATA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONVALLESDELNORTE,lyr_MUNICIPIOSVALLENORTE,lyr_AYATA];
