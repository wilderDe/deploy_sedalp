...
var styleCache_PUERTOCARABUCO={}
var style_PUERTOCARABUCO = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_PUERTOCARABUCO[key]){
        ...
        styleCache_PUERTOCARABUCO[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PUERTOCARABUCO[key]];
