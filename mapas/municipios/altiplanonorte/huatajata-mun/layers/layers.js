...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_HUATAJATA = new ol.format.GeoJSON();
var features_HUATAJATA = format_HUATAJATA.readFeatures(geojson_HUATAJATA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_HUATAJATA = new ol.source.Vector();
jsonSource_HUATAJATA.addFeatures(features_HUATAJATA);var lyr_HUATAJATA = new ol.layer.Vector({
                source:jsonSource_HUATAJATA, 
                style: style_HUATAJATA,
                title: "HUATAJATA"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_HUATAJATA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_HUATAJATA];
