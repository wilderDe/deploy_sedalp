...
var styleCache_AYATA={}
var style_AYATA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_AYATA[key]){
        ...
        styleCache_AYATA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_AYATA[key]];
