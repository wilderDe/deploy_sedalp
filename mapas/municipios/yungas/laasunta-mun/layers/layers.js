...
jsonSource_MUNISYUNGAS.addFeatures(features_MUNISYUNGAS);var lyr_MUNISYUNGAS = new ol.layer.Vector({
                ...
                title: "MUNIS_YUNGAS"
            });var format_LAASUNTA = new ol.format.GeoJSON();
var features_LAASUNTA = format_LAASUNTA.readFeatures(geojson_LAASUNTA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_LAASUNTA = new ol.source.Vector();
jsonSource_LAASUNTA.addFeatures(features_LAASUNTA);var lyr_LAASUNTA = new ol.layer.Vector({
                source:jsonSource_LAASUNTA, 
                style: style_LAASUNTA,
                title: "LAASUNTA"
            });

lyr_YUNGAS.setVisible(true);lyr_MUNISYUNGAS.setVisible(true);lyr_LAASUNTA.setVisible(true);
var layersList = [baseLayer,lyr_YUNGAS,lyr_MUNISYUNGAS,lyr_LAASUNTA];
