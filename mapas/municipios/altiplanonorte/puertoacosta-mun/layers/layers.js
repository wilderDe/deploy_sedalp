...
jsonSource_MUNISALTIPLANONORTE.addFeatures(features_MUNISALTIPLANONORTE);var lyr_MUNISALTIPLANONORTE = new ol.layer.Vector({
            ...
            });var format_PUERTOACOSTA = new ol.format.GeoJSON();
var features_PUERTOACOSTA = format_PUERTOACOSTA.readFeatures(geojson_PUERTOACOSTA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_PUERTOACOSTA = new ol.source.Vector();
jsonSource_PUERTOACOSTA.addFeatures(features_PUERTOACOSTA);var lyr_PUERTOACOSTA = new ol.layer.Vector({
                source:jsonSource_PUERTOACOSTA, 
                style: style_PUERTOACOSTA,
                title: "PUERTOACOSTA"
            });

lyr_REGIONALTIPLANONORTE.setVisible(true);lyr_MUNISALTIPLANONORTE.setVisible(true);lyr_PUERTOACOSTA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANONORTE,lyr_MUNISALTIPLANONORTE,lyr_PUERTOACOSTA];
