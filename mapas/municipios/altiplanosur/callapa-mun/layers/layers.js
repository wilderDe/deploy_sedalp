...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_SANTIAGOCALLAPA = new ol.format.GeoJSON();
var features_SANTIAGOCALLAPA = format_SANTIAGOCALLAPA.readFeatures(geojson_SANTIAGOCALLAPA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_SANTIAGOCALLAPA = new ol.source.Vector();
jsonSource_SANTIAGOCALLAPA.addFeatures(features_SANTIAGOCALLAPA);var lyr_SANTIAGOCALLAPA = new ol.layer.Vector({
                source:jsonSource_SANTIAGOCALLAPA, 
                style: style_SANTIAGOCALLAPA,
                title: "SANTIAGOCALLAPA"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_SANTIAGOCALLAPA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_SANTIAGOCALLAPA];
