...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [486159.276700, 8219181.913100, 725976.908800, 8689065.792900], maxZoom: 28, minZoom: 1, projection: 'EPSG:32719'
    })
});
map.getView().fit([486159.276700, 8219181.913100, 725976.908800, 8689065.792900], map.getSize());
