...
var styleCache_UMALA={}
var style_UMALA = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_UMALA[key]){
        ...
        styleCache_UMALA[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_UMALA[key]];
