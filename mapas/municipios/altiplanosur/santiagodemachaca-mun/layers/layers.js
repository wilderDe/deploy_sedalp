...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_SANTIAGOMACHACA = new ol.format.GeoJSON();
var features_SANTIAGOMACHACA = format_SANTIAGOMACHACA.readFeatures(geojson_SANTIAGOMACHACA, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_SANTIAGOMACHACA = new ol.source.Vector();
jsonSource_SANTIAGOMACHACA.addFeatures(features_SANTIAGOMACHACA);var lyr_SANTIAGOMACHACA = new ol.layer.Vector({
                source:jsonSource_SANTIAGOMACHACA, 
                style: style_SANTIAGOMACHACA,
                title: "SANTIAGOMACHACA"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_SANTIAGOMACHACA.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_SANTIAGOMACHACA];
