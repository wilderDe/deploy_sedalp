...
var styleCache_GUAQUI={}
var style_GUAQUI = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_GUAQUI[key]){
        ...
        styleCache_GUAQUI[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_GUAQUI[key]];
