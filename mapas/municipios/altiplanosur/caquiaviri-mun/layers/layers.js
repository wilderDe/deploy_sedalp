...
jsonSource_MUNIIPIOSALTIPLANOSUR.addFeatures(features_MUNIIPIOSALTIPLANOSUR);var lyr_MUNIIPIOSALTIPLANOSUR = new ol.layer.Vector({
            ...
            });var format_CAQUIAVIRI = new ol.format.GeoJSON();
var features_CAQUIAVIRI = format_CAQUIAVIRI.readFeatures(geojson_CAQUIAVIRI, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32719'});
var jsonSource_CAQUIAVIRI = new ol.source.Vector();
jsonSource_CAQUIAVIRI.addFeatures(features_CAQUIAVIRI);var lyr_CAQUIAVIRI = new ol.layer.Vector({
                source:jsonSource_CAQUIAVIRI, 
                style: style_CAQUIAVIRI,
                title: "CAQUIAVIRI"
            });

lyr_REGIONALTIPLANOSUR.setVisible(true);lyr_MUNIIPIOSALTIPLANOSUR.setVisible(true);lyr_CAQUIAVIRI.setVisible(true);
var layersList = [baseLayer,lyr_REGIONALTIPLANOSUR,lyr_MUNIIPIOSALTIPLANOSUR,lyr_CAQUIAVIRI];
